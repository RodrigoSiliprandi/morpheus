...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { estado: @cidade.estado, idcidade: @cidade.idcidade, nome: @cidade.nome } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { estado: @cidade.estado, idcidade: @cidade.idcidade, nome: @cidade.nome } }
